...
export * from "./adapter/driven/repositories/ClienteMySqlRepositoryGateway";
...
export * from "./core/application/exceptions/ClienteNaoEncontradoException";
...
export * from "./core/application/ports/IClienteRepositoryGateway";
...
export * from "./core/application/useCases/ObterClienteUseCase";
